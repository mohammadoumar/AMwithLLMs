...
parser.add_argument("task", help="The pipeline task to execute.", type=str, choices=["acc", "aric", "joint"])
...
train_dataset_name = f"""abstRCT_{TASK}_train_neo.json"""
...
for test_set in ['neo', 'gla', 'mix']:
    ...
    test_dataset_name = f"""abstRCT_{TASK}_test_{test_set}.json"""
    test_dataset_file = os.path.join(DATASET_DIR, test_dataset_name)
